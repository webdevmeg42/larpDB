    ...
    <div className="rounded-lg overflow-hidden border border-border shadow-sm">
      ...
      <div style={{ background: colorBackground }}>
        ...
        <div style={{ background: colorPrimary, padding: '10px 16px' }}>
          <span style={{ color: colorText, fontWeight: 700, fontSize: '0.9rem', fontFamily: headingFamily }}>
            {siteTitle}
          </span>
        </div>
        ...
        <div style={{ padding: '20px 16px', borderBottom: `1px solid ${colorSecondary}33` }}>
          <h2 style={{ fontFamily: headingFamily, color: colorText, fontSize: '1.4rem', fontWeight: 700, marginBottom: '4px' }}>
            {siteTitle}
          </h2>
          {tagline && (
            <p style={{ fontFamily: bodyFamily, color: colorText, opacity: 0.7, fontSize: '0.85rem', marginBottom: '12px' }}>
              {tagline}
            </p>
          )}
          <button
            type="button"
            style={{ background: colorAccent, color: colorBackground, fontFamily: bodyFamily, fontWeight: 700, padding: '6px 14px', borderRadius: '4px', border: 'none', fontSize: '0.78rem', cursor: 'default' }}
          >
            Join Now
          </button>
        </div>
        ...
        <div style={{ padding: '16px', borderBottom: `1px solid ${colorSecondary}33` }}>
          <p style={{ fontFamily: bodyFamily, color: colorText, opacity: 0.8, fontSize: '0.8rem', lineHeight: 1.6 }}>
        ...
        <div style={{ background: colorSecondary, padding: '8px 16px' }}>
          <span style={{ fontFamily: bodyFamily, color: colorBackground, fontSize: '0.7rem', opacity: 0.9 }}>
