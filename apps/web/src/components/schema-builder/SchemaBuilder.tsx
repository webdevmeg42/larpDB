...
import type { SchemaField, SchemaFieldType, CharacterSchemaType, Faction } from '@plotrunner/shared'
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden min-w-0">
        ...
        <div className="w-72 shrink-0 overflow-y-auto">
          {selectedField ? (
            <FieldEditor field={selectedField} onChange={updateField} {...(schemaType !== undefined && { schemaType })} highlightUnlabeled={saveAttempted} {...(codexFactions !== undefined && { codexFactions })} />
          ) : (
